// Escuchar mensajes desde popup.js o content.js
chrome.runtime.onMessage.addListener((request, sender, sendResponse) => {
    ...
    if (request.type === "saveConfig") {
        ...
        return true; // Permitir el uso de sendResponse de forma asíncrona
    }
});

// Evento al instalar o actualizar la extensión
...
// Cargar configuración cuando se inicia Chrome
